...
eval("const NovelPage = __webpack_require__(/*! ./NovelPage */ \"./NovelPage.js\");\r\n\r\nfunction init(index, pageId, config, axios, key1, key2, key3, baseUrl) {\r\n  return config.FileLinkInfo.PageLinkInfoList.map((item, pageIndex) => {\r\n    return new NovelPage[\"default\"](index, pageId, config, axios, key1, key2, key3, baseUrl, pageIndex);\r\n  })\r\n}\r\n\r\nexports.__esModule = true;\r\nmodule.exports = {\r\n  init: init\r\n};\n\n//# sourceURL=webpack://NovelPage/./index.js?");
